...
class ApprovalController extends Component
{
    ...
    public $s_id,$s_name,$s_label_name,$user_name,$s_thumbnail,$s_audio,$s_album_name,$s_adult,$s_duration,$s_category,$s_subcategory,$s_genre,$s_language,$s_description,$s_caller_tune_name;
