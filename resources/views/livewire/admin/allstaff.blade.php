<div>
	<div class="card card-post">
		...
		<div class="card-body">
			...
			{!! $allstaff->links('pagination::bootstrap-5') !!}
		</div>
	</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="modal-footer m-2">
					...
					<button wire:click='updateStaff' class="btn btn-primary">Update</button>
				</div>
...
<div wire:ignore.self class="modal fade" id="addStaffModal" data-bs-backdrop="static" aria-labelledy='addModallabel'
	data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					<input type="password" class="form-control" wire:model="password" placeholder="Enter User Password">
				...
				<div class="modal-footer m-2">
					...
					<button wire:click='addStaffUser' class="btn btn-primary">Save</button>
				</div>
