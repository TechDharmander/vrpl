<div>
    <div class="card card-post">
        <div class="card-header">
          <h5 class="card-title">Song Lyricists</h5>
          {{-- <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal"><i class="ri-menu-add-fill"></i> Add Song Lyricists</a> --}}
        </div>
        ...
        <div class="card-body">
	      ...
	      {!! $lyricistslist->links('pagination::bootstrap-5') !!}
	    </div>
