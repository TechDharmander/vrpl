    ...
    <div class="dropdown-menu dropdown-menu-end mt-10-f me--10-f">
      ...
      <ul class="list-group">
        <li class="list-group-item">
          <div class="avatar online"><img src="../backend/assets/img/img10.jpg" alt=""></div>
        ...
        <li class="list-group-item">
          <div class="avatar online"><img src="../backend/assets/img/img11.jpg" alt=""></div>
          <div class="list-group-body">
        ...
        <li class="list-group-item">
          <div class="avatar online"><img src="../backend/assets/img/img14.jpg" alt=""></div>
          <div class="list-group-body">
        ...
        <li class="list-group-item">
          <div class="avatar online"><img src="../backend/assets/img/img15.jpg" alt=""></div>
          <div class="list-group-body">
  ...
  <div class="dropdown dropdown-profile ms-3 ms-xl-4">
      ...
      <div class="dropdown-menu dropdown-menu-end mt-10-f">
        <div class="dropdown-menu-body">
          <div class="d-flex">
            <div class="avatar avatar-xl online mb-3"><img src="../backend/assets/img/img1.jpg" alt=""></div>
            <div class="p-2">
